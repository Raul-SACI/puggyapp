...
import type { Expense, ExpenseOverride } from '../lib/types'
...
export function ExpensesScreen() {
  ...
  return (
    <div className="screen">
      ...
      {subtab === 'lista' && (
        <ExpensesList items={items} loading={loading} error={error} reload={reload} />
      )}
      {subtab === 'calendario' && (
        <ExpensesCalendar items={items} overrides={overrides} reload={reload} />
      )}
